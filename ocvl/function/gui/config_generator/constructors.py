...
from PySide6.QtGui import QAction, QPixmap, QFontMetrics, QDoubleValidator
...
class FormatElementsEditor(QDialog):
    ...
    def __init__(self, current_format=None, parent=None, queryloc=False):
        super().__init__(parent)
    ...
    def move_element_up(self):
        """Move the selected element up in the selected list"""
...
class FormatEditorWidget(QWidget):
    ...
    def __init__(self, label_text, default_format="", parent=None, queryloc=False):
        super().__init__(parent)
    ...
    def _open_format_editor(self):
        ...
        dialog = FormatElementsEditor(self.current_format, self, self.queryloc)
...
class GroupByFormatEditorWidget(FormatEditorWidget):
    ...
    def update_format_sources(self, image_format, video_format, mask_format):
        ...
        if invalid:
            print(f"[DEBUG] GroupBy format '{self.current_format}' has invalid fields: {invalid} — clearing.")
            self.current_format = ""
    ...
    def _open_format_editor(self):
        ...
        dialog = FormatElementsEditor(current_format, self)
